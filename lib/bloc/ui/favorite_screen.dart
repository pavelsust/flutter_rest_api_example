    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Restaurant>>(
        ...
        builder: (context, snapshot){
          List<Restaurant> favorites = (snapshot.connectionState == ConnectionState.waiting)? bloc.favourite : snapshot.data;
          ...
          return ListView.separated(itemBuilder: (context , index){
            ...
            return ListTile(
              leading: ImageContainer(
                width: 50, height: 50, url: restaurant.thumbUrl,
              ),
          ...
          }, separatorBuilder: (context , index)=> Divider(), itemCount: favorites.length)
        },
      ),
    );
  }
